---
description: Guide for matching content to the correct MAI slide template. Use this to select templates based on content PURPOSE, including decision trees, common errors, and color rules.
---
